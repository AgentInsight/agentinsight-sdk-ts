...
describe("Tracing Methods Interoperability E2E Tests", () => {
  ...
  describe("startObservation method", () => {
    ...
    it("should create span with custom attributes", async () => {
      ...
      assertions.expectSpanAttribute(
        "test-span",
        AgentInsightOtelSpanAttributes.OBSERVATION_METADATA + ".key",
        "value",
      );
      assertions.expectSpanAttribute(
        "test-span",
    ...
    it("should handle span with error status", async () => {
      ...
      assertions.expectSpanAttribute(
        "error-span",
        AgentInsightOtelSpanAttributes.OBSERVATION_LEVEL,
        "ERROR",
      );
      assertions.expectSpanAttribute(
        "error-span",
        AgentInsightOtelSpanAttributes.OBSERVATION_STATUS_MESSAGE,
        "Test error",
      );
    });
    ...
    describe("Nested spans", () => {
      ...
      it("should handle multiple child spans", async () => {
        ...
        assertions.expectSpanAttributeContains(
          "parent-span",
          AgentInsightOtelSpanAttributes.TRACE_METADATA + ".test_type",
          "multi-child",
        );
        assertions.expectSpanAttributeContains(
          "parent-span",
    ...
    describe("Environment and release attributes", () => {
      it("should add environment and release attributes from span processor", async () => {
        ...
        assertions.expectSpanAttribute(
          "env-span",
          AgentInsightOtelSpanAttributes.RELEASE,
          "v1.0.0",
        );
      });
    });
  ...
  describe("startObservation with generation type", () => {
    it("should create generation with proper observation type", async () => {
      ...
      assertions.expectSpanAttribute(
        "test-generation",
        AgentInsightOtelSpanAttributes.OBSERVATION_MODEL,
        "gpt-4",
      );
      assertions.expectSpanAttribute(
        "test-generation",
      ...
      assertions.expectSpanAttribute(
        "test-generation",
        AgentInsightOtelSpanAttributes.OBSERVATION_METADATA + ".test_run",
        "true",
      );
      assertions.expectSpanAttribute(
        "test-generation",
        AgentInsightOtelSpanAttributes.OBSERVATION_METADATA + ".version",
        "1.0",
      );
  ...
  describe("startObservation with event type", () => {
    it("should create event with proper observation type", async () => {
      ...
      assertions.expectSpanAttribute(
        "test-event",
        AgentInsightOtelSpanAttributes.OBSERVATION_METADATA + ".element",
        "button",
      );
      assertions.expectSpanAttributeContains(
        "test-event",
      ...
      assertions.expectSpanAttribute(
        "event-parent",
        AgentInsightOtelSpanAttributes.TRACE_METADATA + ".platform",
        "web",
      );
    });
    ...
    it("should create event with custom timestamp", async () => {
      ...
      assertions.expectSpanAttribute(
        "timestamped-event",
        AgentInsightOtelSpanAttributes.OBSERVATION_METADATA + ".source",
        "test-suite",
      );
      assertions.expectSpanAttributeContains(
        "timestamped-event",
  ...
  describe("startObservation with agent type", () => {
    ...
    it("should allow updating agent attributes", async () => {
      ...
      assertions.expectSpanAttribute(
        "agent-with-updates",
        AgentInsightOtelSpanAttributes.OBSERVATION_METADATA + ".processingTime",
        "150",
      );
    });
  });
  ...
  describe("startActiveObservation method", () => {
    it("should execute function with active span context", async () => {
      ...
      assertions.expectSpanAttribute(
        "active-span",
        AgentInsightOtelSpanAttributes.TRACE_METADATA + ".execution_context",
        "active",
      );
  ...
  describe("startActiveObservation with generation type", () => {
    ...
    describe("Promise handling for generations", () => {
      it("should handle LLM generation promise resolution", async () => {
        ...
        assertions.expectSpanAttribute(
          "async-llm-generation",
          AgentInsightOtelSpanAttributes.OBSERVATION_METADATA + ".temperature",
          "0.7",
        );
        assertions.expectSpanAttribute(
          "async-llm-generation",
          AgentInsightOtelSpanAttributes.OBSERVATION_METADATA + ".max_tokens",
          "100",
        );
  ...
  describe("Method interoperability", () => {
    it("should create complex trace with all observation types", async () => {
      ...
      assertions.expectSpanAttribute(
        "ai-workflow",
        AgentInsightOtelSpanAttributes.TRACE_PUBLIC,
        true,
      );
      assertions.expectSpanAttribute(
        "ai-workflow",
  ...
  describe("Active span/generation/trace update methods", () => {
    ...
    describe("updateActiveGeneration", () => {
      ...
      it("should update generation during observe function with asType generation", async () => {
        ...
        assertions.expectSpanAttribute(
          "llmFunc",
          AgentInsightOtelSpanAttributes.OBSERVATION_METADATA + ".provider",
          "openai",
        );
      });
    });
    ...
    describe("Combined update methods", () => {
      it("should handle setActiveTraceIO and updateActiveObservation together", async () => {
        ...
        assertions.expectSpanAttribute(
          "combined-span",
          AgentInsightOtelSpanAttributes.OBSERVATION_METADATA + ".step",
          "1",
        );
      });
