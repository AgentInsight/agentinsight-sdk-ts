import {
  AgentInsightSpanProcessor,
  type AgentInsightSpanProcessorParams,
} from "@agentinsight-sdk/otel";
...
export interface TestEnvironment {
  sdk: NodeSDK;
  spanProcessor: AgentInsightSpanProcessor;
...
export interface TestSetupOptions {
  ...
  spanProcessorConfig?: Partial<AgentInsightSpanProcessorParams>;
  mockExporterConfig?: {
    shouldFail?: boolean;
    exportDelay?: number;
  };
...
export async function setupTestEnvironment(
  ...
  const spanProcessor = new AgentInsightSpanProcessor({
