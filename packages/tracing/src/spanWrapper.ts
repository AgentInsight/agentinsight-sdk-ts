...
import { getAgentInsightTracer } from "./tracerProvider.js";
import {
  AgentInsightGenerationAttributes,
  AgentInsightSpanAttributes,
...
import type {
  ...
  AgentInsightEmbeddingAttributes,
...
/**
 * Union type representing any AgentInsight observation wrapper.
 *
 * This type encompasses all observation types supported by AgentInsight, providing
 ...
 *
 * ## Included Types
 * - **AgentInsightSpan**: General-purpose operations and workflows
 * - **AgentInsightGeneration**: LLM calls and AI model interactions
 * - **AgentInsightEmbedding**: Text embedding and vector operations
 * - **AgentInsightAgent**: AI agent workflows with tool usage
 * - **AgentInsightTool**: Individual tool calls and API requests
 * - **AgentInsightChain**: Multi-step processes and pipelines
 * - **AgentInsightRetriever**: Document retrieval and search operations
 * - **AgentInsightEvaluator**: Quality assessment and scoring
 * - **AgentInsightGuardrail**: Safety checks and content filtering
 * - **AgentInsightEvent**: Point-in-time occurrences and log entries
 *
 * @example
 * ```typescript
 * // Function accepting any observation type
 * function logObservation(obs: AgentInsightObservation) {
 ...
 * @public
 */
export type AgentInsightObservation =
  | AgentInsightSpan
...
/**
 * Parameters for creating a AgentInsight observation wrapper.
 *
 * @internal
 */
type AgentInsightObservationParams = {
  otelSpan: Span;
...
/**
 * Base class for all AgentInsight observation wrappers providing unified functionality.
 *
 * This abstract class serves as the foundation for all observation types in AgentInsight,
 ...
 *
 * ## Core Capabilities
 * - **OpenTelemetry Integration**: Wraps OTEL spans with AgentInsight-specific functionality
 ...
 * const observation: AgentInsightObservation = startObservation('my-operation');
 *
 ...
 * @internal
 */
abstract class AgentInsightBaseObservation {
  /** The underlying OpenTelemetry span */
  public readonly otelSpan: Span;
  /** The underlying OpenTelemetry span */
  public readonly type: AgentInsightObservationType;
  /** The span ID from the OpenTelemetry span context */
  public id: string;
  /** The trace ID from the OpenTelemetry span context */
  public traceId: string;

  constructor(params: AgentInsightObservationParams) {
  ...
  /** Gets the AgentInsight OpenTelemetry tracer instance */
  protected get tracer() {
    return getAgentInsightTracer();
  }
  ...
  updateOtelSpanAttributes(attributes: AgentInsightObservationAttributes) {
    this.otelSpan.setAttributes(
   ...
   *
   * @deprecated This is a legacy method for backward compatibility with AgentInsight platform
   ...
   * ```
   */
  public setTraceIO(attributes: AgentInsightTraceAttributes) {
  ...
  public setTraceAsPublic() {
    this.otelSpan.setAttributes({
      [AgentInsightOtelSpanAttributes.TRACE_PUBLIC]: true,
    });
   ...
   * }, { asType: 'generation' }); // Returns AgentInsightGeneration
   *
   ...
   *     maxIterations: 5
   *   }
   * }, { asType: 'agent' }); // Returns AgentInsightAgent
   *
   ...
   *     timeout: 10000
   *   }
   * }, { asType: 'tool' }); // Returns AgentInsightTool
   *
   ...
   *     similarity: 'cosine'
   *   }
   * }, { asType: 'retriever' }); // Returns AgentInsightRetriever
   *
   ...
   *   }
   * }, { asType: 'evaluator' }); // Returns AgentInsightEvaluator
   *
   ...
   *     confidence: 0.95
   *   }
   * }, { asType: 'guardrail' }); // Returns AgentInsightGuardrail
   *
   ...
   *   }
   * }, { asType: 'embedding' }); // Returns AgentInsightEmbedding
   *
   ...
   *   }
   * }, { asType: 'event' }); // Returns AgentInsightEvent (auto-ended)
   *
  ...
  public startObservation(
    name: string,
    attributes: AgentInsightEventAttributes,
    options: { asType: "event" },
  ): AgentInsightEvent;
  public startObservation(
    name: string,
    attributes: AgentInsightAgentAttributes,
    options: { asType: "agent" },
  ): AgentInsightAgent;
  public startObservation(
    name: string,
    attributes: AgentInsightToolAttributes,
    options: { asType: "tool" },
  ): AgentInsightTool;
  public startObservation(
    name: string,
    attributes: AgentInsightChainAttributes,
    options: { asType: "chain" },
  ): AgentInsightChain;
  public startObservation(
    name: string,
    attributes: AgentInsightRetrieverAttributes,
    options: { asType: "retriever" },
  ): AgentInsightRetriever;
  public startObservation(
    name: string,
    attributes: AgentInsightEvaluatorAttributes,
    options: { asType: "evaluator" },
  ): AgentInsightEvaluator;
  public startObservation(
    name: string,
    attributes: AgentInsightGuardrailAttributes,
    options: { asType: "guardrail" },
  ): AgentInsightGuardrail;
  public startObservation(
    name: string,
    attributes: AgentInsightEmbeddingAttributes,
  ...
  public startObservation(
    ...
    attributes?:
      ...
      | AgentInsightGuardrailAttributes
      | AgentInsightEmbeddingAttributes,
    options?: { asType?: AgentInsightObservationType },
  ): AgentInsightObservation {
 ...
 *
 * AgentInsightSpan is the default and most versatile observation type, designed for tracing
 ...
 * @see {@link AgentInsightGeneration} - For LLM and AI model interactions
 * @see {@link AgentInsightEvent} - For point-in-time occurrences
 *
 * @public
 */
export class AgentInsightSpan extends AgentInsightBaseObservation {
  constructor(params: AgentInsightSpanParams) {
   ...
   * ```
   */
  public update(attributes: AgentInsightSpanAttributes): AgentInsightSpan {
 ...
 *
 * AgentInsightAgent is designed for observing intelligent agent systems that combine reasoning,
 ...
 * @see {@link AgentInsightTool} - For individual tool executions within agents
 * @see {@link AgentInsightChain} - For structured multi-step workflows
 *
 * @public
 */
export class AgentInsightAgent extends AgentInsightBaseObservation {
  constructor(params: AgentInsightAgentParams) {
   ...
   * ```
   */
  public update(attributes: AgentInsightAgentAttributes): AgentInsightAgent {
    super.updateOtelSpanAttributes(attributes);
 ...
 *
 * AgentInsightTool is designed for observing discrete tool invocations within agent workflows,
 ...
 * @see {@link AgentInsightAgent} - For agent workflows that use multiple tools
 * @see {@link AgentInsightChain} - For orchestrated tool sequences
 *
 * @public
 */
export class AgentInsightTool extends AgentInsightBaseObservation {
  constructor(params: AgentInsightToolParams) {
   ...
   * ```
   */
  public update(attributes: AgentInsightToolAttributes): AgentInsightTool {
    super.updateOtelSpanAttributes(attributes);
 ...
 *
 * AgentInsightChain is designed for observing sequential, parallel, or conditional workflow orchestration
 ...
 * @see {@link AgentInsightSpan} - For individual workflow steps
 * @see {@link AgentInsightAgent} - For intelligent workflow orchestration
 *
 * @public
 */
export class AgentInsightChain extends AgentInsightBaseObservation {
  constructor(params: AgentInsightChainParams) {
   ...
   * ```
   */
  public update(attributes: AgentInsightChainAttributes): AgentInsightChain {
    super.updateOtelSpanAttributes(attributes);
...
type AgentInsightRetrieverParams = {
  otelSpan: Span;
  attributes?: AgentInsightRetrieverAttributes;
};
 ...
 *
 * AgentInsightRetriever is designed for observing information retrieval systems that search,
 ...
 * @see {@link AgentInsightChain} - For multi-step RAG pipelines
 * @see {@link AgentInsightEmbedding} - For embedding generation used in vector search
 *
 * @public
 */
export class AgentInsightRetriever extends AgentInsightBaseObservation {
  constructor(params: AgentInsightRetrieverParams) {
...
type AgentInsightEvaluatorParams = {
  otelSpan: Span;
  attributes?: AgentInsightEvaluatorAttributes;
};
 ...
 *
 * AgentInsightEvaluator is designed for observing evaluation systems that assess, score, and
 ...
 * @see {@link AgentInsightGeneration} - For LLM outputs being evaluated
 * @see {@link AgentInsightGuardrail} - For safety and compliance enforcement
 *
 * @public
 */
export class AgentInsightEvaluator extends AgentInsightBaseObservation {
  constructor(params: AgentInsightEvaluatorParams) {
...
type AgentInsightGuardrailParams = {
  otelSpan: Span;
  attributes?: AgentInsightGuardrailAttributes;
};
 ...
 *
 * AgentInsightGuardrail is designed for observing safety and compliance systems that prevent,
 ...
 * @see {@link AgentInsightEvaluator} - For detailed quality and safety assessment
 * @see {@link AgentInsightGeneration} - For protecting LLM outputs with guardrails
 *
 * @public
 */
export class AgentInsightGuardrail extends AgentInsightBaseObservation {
  constructor(params: AgentInsightGuardrailParams) {
...
/**
 * Parameters for creating a AgentInsight generation.
 *
 * @internal
 */
type AgentInsightGenerationParams = {
  otelSpan: Span;
  attributes?: AgentInsightGenerationAttributes;
};
 ...
 *
 * AgentInsightGeneration is purpose-built for observing AI model interactions, providing rich
 ...
 * @see {@link AgentInsightSpan} - For general-purpose operations
 * @see {@link AgentInsightEmbedding} - For text embedding and vector operations
 *
 * @public
 */
export class AgentInsightGeneration extends AgentInsightBaseObservation {
  constructor(params: AgentInsightGenerationParams) {
    super({ ...params, type: "generation" });
  }

  update(attributes: AgentInsightGenerationAttributes): AgentInsightGeneration {
...
type AgentInsightEmbeddingParams = {
  otelSpan: Span;
  attributes?: AgentInsightEmbeddingAttributes;
};
 ...
 *
 * AgentInsightEmbedding is designed for observing embedding model interactions that convert
 ...
 * @see {@link AgentInsightRetriever} - For using embeddings in vector search
 * @see {@link AgentInsightGeneration} - For LLM operations that may use embeddings
 *
 * @public
 */
export class AgentInsightEmbedding extends AgentInsightBaseObservation {
  constructor(params: AgentInsightEmbeddingParams) {
   ...
   */
  update(attributes: AgentInsightEmbeddingAttributes): AgentInsightEmbedding {
    this.updateOtelSpanAttributes(attributes);
...
/**
 * Parameters for creating a AgentInsight event.
 *
 * @internal
 */
type AgentInsightEventParams = {
  otelSpan: Span;
  attributes?: AgentInsightEventAttributes;
  timestamp: TimeInput;
};
...
/**
 * AgentInsight event wrapper for point-in-time observations.
 *
 ...
 * @public
 */
export class AgentInsightEvent extends AgentInsightBaseObservation {
  constructor(params: AgentInsightEventParams) {
