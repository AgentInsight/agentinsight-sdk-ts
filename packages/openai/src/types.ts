...
/**
 * Configuration options for AgentInsight OpenAI tracing.
 *
 * This interface defines all available options for customizing how OpenAI
 * SDK calls are traced and stored in AgentInsight. It includes both trace-level
 * metadata and generation-specific configuration.
 *
 * @public
 */
export type AgentInsightConfig = {
  ...
  /** Information about the AgentInsight prompt used for this generation */
  agentInsightPrompt?: {
    /** Name of the prompt template in AgentInsight */
    name: string;
