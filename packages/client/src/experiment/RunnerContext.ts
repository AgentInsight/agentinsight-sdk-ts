import type { AgentInsightClient } from "../AgentInsightClient.js";
...
/**
 * Wraps `agentInsight.experiment.run` with CI-injected defaults.
 *
...
export class RunnerContext<
  ...
  Metadata extends Record<string, any> = Record<string, any>,
> {
  public readonly client: AgentInsightClient;
