...
export class TextPromptClient extends BasePromptClient {
   ...
   * @example
   * ```typescript
   * const prompt = await agentInsight.prompt.get("greeting", { type: "text" });
...
export class ChatPromptClient extends BasePromptClient {
   ...
   * @example
   * ```typescript
   * const prompt = await agentInsight.prompt.get("conversation", { type: "chat" });
 ...
 * @public
 */
export type AgentInsightPromptClient = TextPromptClient | ChatPromptClient;
