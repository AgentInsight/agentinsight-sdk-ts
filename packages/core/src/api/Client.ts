...
export declare namespace AgentInsightAPIClient {
  export interface Options {
    ...
    /** Override the X-AgentInsight-Sdk-Name header */
    xAgentInsightSdkName?: core.Supplier<string | undefined>;
    /** Override the X-AgentInsight-Sdk-Version header */
    xAgentInsightSdkVersion?: core.Supplier<string | undefined>;
    /** Override the X-AgentInsight-Public-Key header */
...
export class AgentInsightAPIClient {
  protected readonly _options: AgentInsightAPIClient.Options;
  ...
  constructor(_options: AgentInsightAPIClient.Options) {
    this._options = {
      ..._options,
      headers: mergeHeaders(
        {
          "X-Langfuse-Sdk-Name": _options?.xAgentInsightSdkName,
          "X-Langfuse-Sdk-Version": _options?.xAgentInsightSdkVersion,
          "X-Langfuse-Public-Key": _options?.xAgentInsightPublicKey,
        },
        _options?.headers,
      ),
    };
