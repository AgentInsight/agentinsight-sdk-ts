...
export class Organizations {
  ...
  ): core.HttpResponsePromise<AgentInsightAPI.MembershipsResponse> {
  ...
  private async __getOrganizationMemberships(
    requestOptions?: Organizations.RequestOptions,
  ): Promise<core.WithRawResponse<AgentInsightAPI.MembershipsResponse>> {
    ...
    if (_response.ok) {
      return {
        data: _response.body as AgentInsightAPI.MembershipsResponse,
   ...
   *
   * @param {AgentInsightAPI.MembershipRequest} request
   * @param {Organizations.RequestOptions} requestOptions - Request-specific configuration.
   *
   * @throws {@link AgentInsightAPI.Error}
   * @throws {@link AgentInsightAPI.UnauthorizedError}
  ...
  public updateOrganizationMembership(
    request: AgentInsightAPI.MembershipRequest,
    requestOptions?: Organizations.RequestOptions,
  ): core.HttpResponsePromise<AgentInsightAPI.MembershipResponse> {
    return core.HttpResponsePromise.fromPromise(
  ...
  private async __updateOrganizationMembership(
    request: AgentInsightAPI.MembershipRequest,
    requestOptions?: Organizations.RequestOptions,
  ): Promise<core.WithRawResponse<AgentInsightAPI.MembershipResponse>> {
    let _headers: core.Fetcher.Args["headers"] = mergeHeaders(
      this._options?.headers,
      mergeOnlyDefinedHeaders({
        Authorization: await this._getAuthorizationHeader(),
    ...
    if (_response.ok) {
      return {
        data: _response.body as AgentInsightAPI.MembershipResponse,
        rawResponse: _response.rawResponse,
      };
    }
   ...
   *
   * @param {AgentInsightAPI.DeleteMembershipRequest} request
   * @param {Organizations.RequestOptions} requestOptions - Request-specific configuration.
   *
   * @throws {@link AgentInsightAPI.Error}
   * @throws {@link AgentInsightAPI.UnauthorizedError}
  ...
  public deleteOrganizationMembership(
    request: AgentInsightAPI.DeleteMembershipRequest,
    requestOptions?: Organizations.RequestOptions,
  ): core.HttpResponsePromise<AgentInsightAPI.MembershipDeletionResponse> {
    return core.HttpResponsePromise.fromPromise(
  ...
  private async __deleteOrganizationMembership(
    request: AgentInsightAPI.DeleteMembershipRequest,
    requestOptions?: Organizations.RequestOptions,
  ): Promise<core.WithRawResponse<AgentInsightAPI.MembershipDeletionResponse>> {
    let _headers: core.Fetcher.Args["headers"] = mergeHeaders(
      this._options?.headers,
      mergeOnlyDefinedHeaders({
        Authorization: await this._getAuthorizationHeader(),
    ...
    if (_response.ok) {
      return {
        data: _response.body as AgentInsightAPI.MembershipDeletionResponse,
        rawResponse: _response.rawResponse,
      };
    }
  ...
  public getOrganizationProjects(
    requestOptions?: Organizations.RequestOptions,
  ): core.HttpResponsePromise<AgentInsightAPI.OrganizationProjectsResponse> {
    return core.HttpResponsePromise.fromPromise(
  ...
  private async __getOrganizationProjects(
    requestOptions?: Organizations.RequestOptions,
  ): Promise<core.WithRawResponse<AgentInsightAPI.OrganizationProjectsResponse>> {
    let _headers: core.Fetcher.Args["headers"] = mergeHeaders(
      this._options?.headers,
      mergeOnlyDefinedHeaders({
        Authorization: await this._getAuthorizationHeader(),
    ...
    if (_response.ok) {
      return {
        data: _response.body as AgentInsightAPI.OrganizationProjectsResponse,
        rawResponse: _response.rawResponse,
      };
    }
  ...
  public getOrganizationApiKeys(
    requestOptions?: Organizations.RequestOptions,
  ): core.HttpResponsePromise<AgentInsightAPI.OrganizationApiKeysResponse> {
    return core.HttpResponsePromise.fromPromise(
  ...
  private async __getOrganizationApiKeys(
    requestOptions?: Organizations.RequestOptions,
  ): Promise<core.WithRawResponse<AgentInsightAPI.OrganizationApiKeysResponse>> {
    let _headers: core.Fetcher.Args["headers"] = mergeHeaders(
      this._options?.headers,
      mergeOnlyDefinedHeaders({
        Authorization: await this._getAuthorizationHeader(),
    ...
    if (_response.ok) {
      return {
        data: _response.body as AgentInsightAPI.OrganizationApiKeysResponse,
        rawResponse: _response.rawResponse,
      };
    }
