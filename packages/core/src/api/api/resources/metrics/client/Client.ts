...
export class Metrics {
   ...
   *
   * @param {AgentInsightAPI.GetMetricsV2Request} request
   ...
   */
  public metrics(
    request: AgentInsightAPI.GetMetricsV2Request,
    requestOptions?: Metrics.RequestOptions,
  ): core.HttpResponsePromise<AgentInsightAPI.MetricsV2Response> {
  ...
  private async __metrics(
    request: AgentInsightAPI.GetMetricsV2Request,
    requestOptions?: Metrics.RequestOptions,
  ): Promise<core.WithRawResponse<AgentInsightAPI.MetricsV2Response>> {
    const { query } = request;
    ...
    if (_response.ok) {
      return {
        data: _response.body as AgentInsightAPI.MetricsV2Response,
