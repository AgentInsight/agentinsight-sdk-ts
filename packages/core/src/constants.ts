...
export const AGENTINSIGHT_TRACER_NAME = "langfuse-sdk";
export const AGENTINSIGHT_SDK_VERSION = packageJson.version;
export const AGENTINSIGHT_SDK_NAME = "javascript";

export const AGENTINSIGHT_SDK_EXPERIMENT_ENVIRONMENT = "sdk-experiment";

// From AgentInsight platform: web/src/features/otel/server/attributes.ts
export enum AgentInsightOtelSpanAttributes {
  // AgentInsight-Trace attributes
  ...
  // AgentInsight-observation attributes
  ...
  // AgentInsight-observation of type Generation attributes
